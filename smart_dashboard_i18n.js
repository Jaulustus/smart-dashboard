(function (global) {
  ...
  const EN_FLAT = {
    ...
    "mcpAgent.connectStep1": "1. Install MCP deps (button above) and scan the library.",
    "mcpAgent.connectStep2": "2. Copy the MCP config below into your agent (Cursor, Claude Desktop, OpenClaw, …).",
    "mcpAgent.connectStep3": "3. Set the absolute path to stash_mcp_server.py in your plugin folder.",
  ...
  const DE_FLAT = {
    ...
    "mcpAgent.connectStep1": "1. MCP-Abhängigkeiten installieren (Button oben) und Bibliothek scannen.",
    "mcpAgent.connectStep2": "2. MCP-Konfiguration unten in deinen Agent kopieren (Cursor, Claude Desktop, OpenClaw, …).",
    "mcpAgent.connectStep3": "3. Absoluten Pfad zu stash_mcp_server.py im Plugin-Ordner eintragen.",
