(function () {
  ...
  const EN_FLAT = {
    ...
    "mcpAgent.statusDbFilePresent": "File on disk ({size}) — index empty, run “Scan full library”",
  ...
  const DE_FLAT = {
    ...
    "mcpAgent.statusDbFilePresent": "Datei vorhanden ({size}) — Index leer, „Gesamte Bibliothek scannen“",
